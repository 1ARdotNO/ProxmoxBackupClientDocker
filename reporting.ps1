...
$Errorstrings="error","warning","fail","denied","refused","Errno","is not recognized as a name of a cmdlet, function, script file, or executable program","Caught non-retryable exception while listing","Exception"
